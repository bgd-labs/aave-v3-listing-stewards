...
import {IGenericV3ListingEngine} from '../common/IGenericV3ListingEngine.sol';
import {AaveV3Polygon} from 'aave-address-book/AaveV3Polygon.sol';

/**
 * @dev Base smart contract for an Aave v3.1 listing.
    ...
    function execute() external {
        ...
        address(LISTING_ENGINE).functionDelegateCall(
            abi.encodeWithSelector(
                LISTING_ENGINE.listAssets.selector,
                getPoolContext(),
                getAllConfigs()
            )
        );
