...
/**
 * @dev This steward lists MIMATIC (MAI) as borrowing asset on Aave V3 Fantom
 ...
 */
contract AaveV3FantomMIMATICListingSteward is StewardBase {
    // **************************
    ...
    string public constant ATOKEN_NAME = 'Aave Fantom MIMATIC';
    string public constant ATOKEN_SYMBOL = 'aFanMIMATIC';
    string public constant VDTOKEN_NAME = 'Aave Fantom Variable Debt MIMATIC';
    string public constant VDTOKEN_SYMBOL = 'variableDebtFanMIMATIC';
    string public constant SDTOKEN_NAME = 'Aave Fantom Stable Debt MIMATIC';
    string public constant SDTOKEN_SYMBOL = 'stableDebtFanMIMATIC';
    ...
    uint256 public constant SUPPLY_CAP = 50_000_000; // 50m
