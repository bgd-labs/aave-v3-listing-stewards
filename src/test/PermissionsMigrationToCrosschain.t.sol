...
contract PermissionsMigrationToCrosschain is TestWithExecutor, BaseAavePermissionsHelper {
  function testPermissionsMigrationOptimism() public {
    vm.createSelectFork('optimism', 70570900);
    ...
    _executePayload(address(OptimismPayloadLib._deploy()));
  ...
  function testPermissionsMigrationArbitrum() public {
    vm.createSelectFork('arbitrum', 55600450);
    ...
    _executePayload(address(ArbitrumPayloadLib._deploy()));
