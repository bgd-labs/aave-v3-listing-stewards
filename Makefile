...
test-v3-ava-risk-params:; forge test -vvv --match-contract AaveV3AvaRiskParamsByGuardian
...
deploy-ava-risk-param-steward-dry-run :; forge script script/DeployAvaRiskParamsSteward.s.sol:DeployAvaRiskParamsSteward --rpc-url ${RPC_AVALANCHE} -vvvv
deploy-ava-risk-param-steward-pk :; forge script script/DeployAvaRiskParamsSteward.s.sol:DeployAvaRiskParamsSteward --rpc-url ${RPC_AVALANCHE} --broadcast --legacy --private-key ${PRIVATE_KEY} --verify --etherscan-api-key ${ETHERSCAN_API_KEY_AVALANCHE} -vvvv
