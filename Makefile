...
deploy-aave-v3-genesis-payload :; forge script script/DeployAaveV3EthereumGenesisPayload.s.sol:DeployAaveV3EthereumGenesisPayload --rpc-url ${ETH_RPC_URL} --broadcast --legacy --ledger --mnemonic-indexes ${MNEMONIC_INDEX} --sender ${LEDGER_SENDER} --verify --etherscan-api-key ${ETHERSCAN_API_KEY} -vvvv