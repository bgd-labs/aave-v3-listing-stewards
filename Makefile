...
test-v3-opt-caps:; forge test -vvv --rpc-url=${RPC_OPTIMISM} --match-contract AaveV3OptCapsByGuardian
test-v3-arb-caps:; forge test -vvv --rpc-url=${RPC_ARBITRUM} --match-contract AaveV3ArbCapsByGuardian
