...
deploy-ava-caps-steward :;  forge script script/DeployAvaCapsSteward.s.sol:DeployAvaCapsSteward --rpc-url ${RPC_AVALANCHE} --broadcast --legacy --private-key ${PRIVATE_KEY} --verify --etherscan-api-key ${ETHERSCAN_API_KEY} -vvvv
